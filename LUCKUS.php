...
echo "\n";
echo "\e[96m            (------Luckus----- $input)               \n";
echo "\e[89m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
echo color("green","# # # # # # # # # # # # # # # # # # # # # # # \n");
echo color("yellow","[•] Time : ".date('[d-m-Y] [H:i:s]')." \n");
echo color("purple","[•] BISSMILLAH ..... \n");
echo color("yellow","[•] VOUCHER GOFOOD  \n");
echo color("green","[•]  PAKAI 62xxxxxxxxxx \n");
echo color("red","[•] ATAU PAKAI 08xxxxxxxx \n");
echo color("blue","[•] JOGJA MEMBARA 🤣 \n");
